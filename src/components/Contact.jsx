        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              placeholder="İsminizi bu kısma yazınız"
              className='bg-tertiary py-4 px-6 placeholder:text-white text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-4'>E-postanız</span>
            <input
              type='email'
              name='email'
              value={form.email}
              onChange={handleChange}
              placeholder="E-postanızı buraya yazınız"
              className='bg-tertiary py-4 px-6 placeholder:text-white text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-4'>Mesajınızı İletin</span>
            <textarea
              rows={7}
              name='message'
              value={form.message}
