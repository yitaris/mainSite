  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>Merhaba Tekrar</p>
      ...
      >
        ...
        şu an bir çok yazılım diline hakim olmaya çalışmaktayım çok 
        fazla hobi edinmeye çalışırım hayatı dolu dolu yaşamak lazım.
      </motion.p>
